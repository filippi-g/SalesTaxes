 ...
 *
 */
public class ItemAllBean extends Item{

	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(ItemAllBean.class);

	ProductDetail productDetail = null;
	String finalCost = null;
	String salesTax = null;

	public ItemAllBean(ProductDetail p){
